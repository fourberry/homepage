<template>
  ...
  class="mx-auto text-center text-gray-500
         ...
         leading-snug
         w-full max-w-[90%] sm:max-w-[36rem] md:max-w-[42rem] lg:max-w-[56rem]
         text-[clamp(0.58rem,2.3vw,1.05rem)] sm:text-[clamp(0.55rem,2vw,1.1rem)] md:text-[clamp(0.6rem,1.8vw,1.2rem)]">
