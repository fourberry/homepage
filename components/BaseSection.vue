...
<template>
    <section class="section-container relative" :class="paddingClass" :style="{ color: textColor }">
        <div
        ...
        <div class="relative z-10 h-full" :class="{ 'mx-auto max-w-8xl px-4 md:px-8': !fullWidth }">
            <slot />
        </div>
    </section>
</template>
