<template>
    <div class="relative h-screen overflow-hidden">
        <!-- Stage 1: 첫 번째 히어로 (CommonPageHero 스타일) -->
        ...
        <!-- Stage 2: 두 번째 히어로 (FOURBERRY 타이핑) -->
        <section ref="stage2" class="absolute inset-0 h-screen min-h-[560px]">
            ...
            <div ref="stage2TextWrapper" class="absolute inset-0 flex items-end justify-start">
                <div class="px-4 pb-16 text-left text-white md:px-16 md:pb-28">
                    <h1 class="h1-custom-font text-[clamp(45px,10vw,150px)] font-black leading-[0.95] tracking-[-0.04em]">
                        WE'RE
                        <br />
                        <span ref="stage2Typing" class="inline-block min-w-[10ch] text-white"></span>
                    </h1>
