<template>
  <section class="relative min-h-[560px] overflow-hidden h-screen">
    ...
    <div
      ref="textWrapper"
      class="absolute inset-0 flex items-end justify-start"
    >
      <div class="text-white px-4 pb-16 md:px-16 md:pb-28 text-left">
        <h1
          class="font-black tracking-[-0.04em] leading-[0.95] text-[clamp(45px,10vw,150px)] h1-custom-font"
        >
          WE’RE<br />
          <span
            ref="fourberry"
            class="inline-block min-w-[10ch] text-white"
          ></span>
        </h1>

        <p
          class="mt-4 text-gray-400 text-[clamp(16px,2.2vw,28px)] font-semibold"
        >
