<template>
  <section class="relative bg-black text-white">
    <div class="mx-auto max-w-7xl px-4 py-28 md:px-10 md:py-36 lg:px-16">
      <!-- 헤더 -->
      ...
      >
        ...
        <p
          class="mt-6 text-lg leading-relaxed text-zinc-300 md:text-xl lg:text-2xl max-w-6xl mx-auto"
        >
          {{ subtitle }}
        </p>
      </header>
  ...
  :key="i"
  class="group relative w-full sm:w-[95%] md:w-[90%] lg:w-[88%] xl:w-[85%] mx-auto"
>
  <div
  ...
  >
    <!-- 🔹 타이틀 -->
    <h3
      class="absolute left-8 md:left-10 -top-6 md:-top-7 
            rounded-full bg-white px-6 py-2
            text-black text-lg md:text-xl font-semibold tracking-tight shadow-md"
    >
      {{ item.title }}
    </h3>
    ...
    <!-- 🔹 설명 -->
    <p
      class="mt-2 text-lg md:text-xl leading-snug text-zinc-300 text-center px-3"
    >
      {{ item.desc }}
    </p>
  </div>
