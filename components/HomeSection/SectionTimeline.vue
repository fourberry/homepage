<template>
  ...
  >
    <div class="max-w-6xl mx-auto px-6 relative">
      <h2 class="text-2xl md:text-3xl font-bold text-center">OUR HISTORY</h2>
...
const raw: RawEvent[] = [
  ...
  },
  {
    date: "2024.10",
    titles: [
      "동행복권 인쇄복권 시스템 DB 전환 사업 착수",
      "한국해양공사 게이미피케이션 캠페인 구축 완료",
    ],
  },
  {
    date: "2025.01",
    titles: [
      "자체 솔루션 **베리마인(Berry-Mine) 개발 착수** (웹 자동화)",
      "쿠쿠홀딩스 시스템 운영 및 고도화 착수",
    ],
  },
...
const yearBlocks = computed<
  Record<string, { month: string; titles: string[] }[]>
>(() => {
